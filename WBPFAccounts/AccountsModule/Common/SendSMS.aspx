<%@ Page Title="Send SMS" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="SendSMS.aspx.cs" Inherits="AccountsModule.Common.SendSMS" %>
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <asp:Button ID="btnSentSMS" runat="server" Text="Sent SMS" CssClass="button" Style="float: right"
                                OnClick="btnSentSMS_Click" OnClientClick="javascript:return Validation()" />
                            <asp:Button ID="btnSentNotification" runat="server" Text="Sent Notification" CssClass="button" Style="float: left"
                                OnClick="btnSentNotification_Click" />
                        </td>
                    </tr>
                </table>
            </div>
