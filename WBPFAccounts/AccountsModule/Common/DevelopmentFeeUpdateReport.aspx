<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="DevelopmentFeeUpdateReport.aspx.cs" Inherits="AccountsModule.Common.DevelopmentFeeUpdateReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="title">
        <h5>
            Development Fee Update Report</h5>
    </div>
                ...
                <td align="center">
                    <asp:GridView ID="dgvMemberMaster" runat="server" AutoGenerateColumns="false" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TotalOriginal" HeaderText="Total Bill Amount" />
                            <asp:BoundField DataField="TotalDiscount" HeaderText="Total Discount Amount" />
                            <asp:BoundField DataField="TotalFinal" HeaderText="Total Final Amount" />
                        </Columns>
                        <EmptyDataTemplate>
                            <p>
                                No Record Found</p>
