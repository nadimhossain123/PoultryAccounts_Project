<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sms-payment-receipt.aspx.cs" Inherits="AccountsModule.Common.sms_payment_receipt" %>
...
<body style="cursor: pointer; font-family: Calibri; font-size: 16px;" onclick="window.print()" onload="window.print()">
