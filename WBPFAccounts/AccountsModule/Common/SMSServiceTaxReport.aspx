<%@ Page Title="SMS Service Tax Report" Language="C#" MasterPageFile="~/MasterAdmin.Master"
    AutoEventWireup="true" CodeBehind="SMSServiceTaxReport.aspx.cs" Inherits="AccountsModule.Common.SMSServiceTaxReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table" width="95%" align="center">
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="ddlSMSCategory" runat="server" Width="190px" class="dropdownList"
                    DataValueField="SMSCategoryId" DataTextField="SMSCategoryName">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
