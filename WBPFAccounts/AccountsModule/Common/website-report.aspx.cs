...
{
    public partial class website_report : System.Web.UI.Page
    {
        ...
        private void LoadConsolidatedOutstandingList()
        {
            ...
            DataSet ds = objMemberPayment.GetOutstandingReportConsolidated(StateId, DistrictId, BlockId, CategoryId, ToDate, FromDate, MemberName,MemberCode, MobileNo,0,0);
