...
{
    public partial class DevelopmentFeesReportConsolidated : System.Web.UI.Page
    {
        ...
        private void LoadConsolidatedOutstandingList()
        {
            ...
            DataTable dt = objMemberPayment.GetDevelopmentFeesReportConsolidated(StateId, DistrictId, BlockId, CategoryId, ToDate, MemberName);
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=DevelopmentFeesReportConsolidated.xls");
