<%@ Page Title="Bird Price/Month" Language="C#" MasterPageFile="~/EmptyMaster.Master" AutoEventWireup="true" 
    CodeBehind="ShowBirdPricePerMonthPublicView.aspx.cs" Inherits="AccountsModule.Common.ShowBirdPricePerMonthPublicView" %>
    ...
    <div style="width:100%;">
        ...
        <table width="50%" align="center" class="table">
            <tr>
                ...
                <td align="right" width="20%"> <asp:Button ID="btnDownload" runat="server" CssClass="button" Text="Download" OnClick="btnDownload_Click" /></td>
            </tr>
        </table>
