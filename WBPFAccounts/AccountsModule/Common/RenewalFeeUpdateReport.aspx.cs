...
{
    public partial class RenewalFeeUpdateReport : System.Web.UI.Page
    {
        ...
        protected void LoadMemberList()
        {
            ...
            DataTable dt = objMemberMaster.RenewalMemberUpdateGetAll(StateId, DistrictId, BlockId, CategoryId, MemberName, MobileNo, BusinessTypeId, FromDate, ToDate);
