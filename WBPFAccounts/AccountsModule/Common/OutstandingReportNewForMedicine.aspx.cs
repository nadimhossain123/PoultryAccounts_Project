...
{
    public partial class MemberOutstandingReportNew : System.Web.UI.Page
    {
        ...
        private void LoadConsolidatedOutstandingList()
        {
            ...
            DataSet ds = objMemberPayment.GetOutstandingReportConsolidatedNewForMedicineRepresentatives(StateId, DistrictId, BlockId, CategoryId, ToDate, FromDate, MemberName, "", "", BusinessTypeId, ReportType);
