<%@ Page Title="Agent SMS Payment Report" Language="C#" MasterPageFile="~/MasterAdmin.Master"
    AutoEventWireup="true" CodeBehind="AgentSMSPaymentReport.aspx.cs" Inherits="AccountsModule.Common.AgentSMSPaymentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="title">
        <h5>Area Manager SMS Payment Report</h5>
    </div>
    <div style="width: 99%;">
        <br />
