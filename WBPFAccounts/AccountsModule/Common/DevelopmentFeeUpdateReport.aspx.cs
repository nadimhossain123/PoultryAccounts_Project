...
{
    public partial class DevelopmentFeeUpdateReport : System.Web.UI.Page
    {
        ...
        protected void LoadMemberList()
        {
            ...
            DataTable dt = objMemberMaster.DevelopmentMemberUpdateGetAll(StateId, DistrictId, BlockId, CategoryId, MemberName, MobileNo, BusinessTypeId, FromDate, ToDate);
