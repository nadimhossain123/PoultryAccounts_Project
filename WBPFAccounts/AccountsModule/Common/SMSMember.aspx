<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="SMSMember.aspx.cs" Inherits="AccountsModule.Common.SMSMember" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function Validation() {
            ...
            else if (document.getElementById('<%=chkIsNECCMember.ClientID %>').checked == false) {
                if (document.getElementById('<%=ddlRegType.ClientID %>').selectedIndex == 0)
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            ...
            <td align="left" colspan="3">
                <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" Height="60px" MaxLength="200"
                    Width="300px" Style="resize: none"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="left">Is NECC Member :
            </td>
            <td align="left">
                <asp:CheckBox ID="chkIsNECCMember" runat="server" />
            </td>
    ...
    <div >
        <table width="100%">
            ...
            <tr>
                <td>
                    <asp:DropDownList ID="ddlSearchDistrict" runat="server" CssClass="dropdownList" Width="150px" DataValueField="DistrictId" DataTextField="DistrictName" ></asp:DropDownList>
                </td>
                <td>
                    <asp:DropDownList ID="ddlNECCOrNot" runat="server" CssClass="dropdownList" Width="100px" >
                        <asp:ListItem Text="ALL" Value="0"></asp:ListItem>
                        <asp:ListItem Text="NECC Member" Value="1"></asp:ListItem>
                        <asp:ListItem Text="SMS Member" Value="2"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <tr>
                <td colspan="6">
                    ...
                    <asp:GridView ID="dgvSMSMember" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        OnRowDeleting="dgvSMSMember_RowDeleting" OnRowEditing="dgvSMSMember_RowEditing"
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="MemberType" HeaderText="Member Type" />
                            <asp:BoundField DataField="IsNECCMember" HeaderText="NECC Member" />
