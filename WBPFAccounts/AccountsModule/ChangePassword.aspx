<%@ Page Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="AccountsModule.ChangePassword" Title="Change Password" %>
    ...
    <asp:UpdatePanel ID="Up1" runat="server">
        <ContentTemplate>
            ...
            <table width="100%" align="center" class="table">
                <tr>
                    <td align="left" width="20%" class="label">New Password:<span class="req">*</span></td>
